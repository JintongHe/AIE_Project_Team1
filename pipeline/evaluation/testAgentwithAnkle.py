...
from ModelsAndUtils import Actor,MLP, TransformerModel, get_right_ankle_substate, get_action_substate  # Import necessary functions and classes
...
model_load_path = os.path.join(os.path.dirname(__file__), "new_36_states_survival.pth")
